...
namespace OneSingleAPI.Classes
{
    ...
    public class AirtimeWordDocumentAttribute : ActionFilterAttribute
    {
        public string DefaultFilename { get; set; }
        ...
        public override void OnActionExecuted(ActionExecutedContext filterContext)
        {
            ...
            if (result != null)
                result.MasterName = "~/Views/Shared/_LayoutWordAirtime.cshtml";
    ...
    public class BillingWordDocumentAttribute : ActionFilterAttribute
    {
        public string DefaultFilename { get; set; }
        ...
        public override void OnActionExecuted(ActionExecutedContext filterContext)
        {
            ...
            if (result != null)
                result.MasterName = "~/Views/Shared/_LayoutWordBilling.cshtml";
